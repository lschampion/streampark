...
trait FlinkClientTrait extends Logger {
  ...
  private val CANCEL_ENABLE:ConfigOption[java.lang.Boolean]=ConfigOptions
    .key("web.cancel.enable")
    .booleanType()
    .defaultValue(true)
    .withDescription( "Flag indicating whether jobs can be canceled from the web-frontend.")
  ...
  def submit(submitRequest: SubmitRequest): SubmitResponse = {
    ...
    flinkConfig
      ...
      .safeSet(CANCEL_ENABLE, JavaBool.FALSE)
